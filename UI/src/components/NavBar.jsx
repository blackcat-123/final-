...
function NavBar() {
  ...
  return (
    <div className="navbar bg-base-100 w-[95%] " data-theme = "light">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 font-semibold ">
          ...
          */}
          ...
          <li className='p-1'>
              <button onClick={()=>navigate("/faq")} className={location.pathname=="/faq"?"btn btn-outline btn-primary":""}>Hướng dẫn</button>
          </li>
        </ul>
      </div>
