    ...
    <div className="flex items-center justify-center hero h-[85vh] w-full bg-gradient-to-r from-teal-100 to-blue-100">
      <div className="hero-content text-center min-w-[200px] ">
        <div className="max-w-md flex-1">
          ...
          <h1 className="text-2xl lg:text-5xl font-bold [&::selection]:text-base-content brightness-100 contrast-150 [&::selection]:bg-blue-950 ">Xin chào! Tôi là</h1>
          ...
          <p className="py-6 font-semibold lg:text-lg text-sm">
            Giúp bạn hỏi đáp, tra cứu thông tin văn bản Luật!
          </p>
          <Link to="/chat">
            <button className="btn btn-info">Bắt đầu</button>
          </Link>
        </div>
      </div>
